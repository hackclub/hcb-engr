...
There’s still more work to do! Reach out if you wish a part of HCB was documented better ([hcb-engr@hackclub.com](mailto:hcb-engr@hackclub.com)). And, if you’re a teenager interested in helping out, join us in the `#hcb-dev` channel on the [Hack Club Slack](https://hackclub.com/slack).
